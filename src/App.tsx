...
import { SteampunkGears } from './components/SteampunkGears';
import { PixelEffects } from './components/PixelEffects';
import { CyberpunkEffects } from './components/CyberpunkEffects';
import { SynthwaveEffects } from './components/SynthwaveEffects';
import { GalaxyEffects } from './components/GalaxyEffects';
import { NordEffects } from './components/NordEffects';
...
function PortfolioContent() {
  ...
  const [terminalHeight, setTerminalHeight] = useState(256); // 64 * 4 = 256px
  ...
  // Gérer la visibilité de l'explorateur selon la taille de l'écran
  useEffect(() => {
    const handleResize = () => {
  ...
  // Écouter l'événement de navigation vers les skills
  useEffect(() => {
