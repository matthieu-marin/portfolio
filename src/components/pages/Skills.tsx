...
// Mapping des IDs de skills vers les noms réels dans skillCategories
...
export function Skills() {
  ...
  // Définition des interfaces (catégories)
  ...
  return (
    <div className="h-full bg-editor/90 backdrop-blur-sm p-4 md:p-8 overflow-auto relative z-10">
      <div className="max-w-6xl mx-auto space-y-6 min-h-full pb-12">
        ...
        {/* Documentation détaillée pour la skill ciblée */}
        {targetSkillId && (
