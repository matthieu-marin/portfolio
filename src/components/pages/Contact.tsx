  ...
  return (
    <div className="h-full bg-editor/90 backdrop-blur-sm p-4 md:p-8 overflow-auto relative z-10">
      <div className="max-w-6xl mx-auto space-y-6 min-h-full pb-12">
          ...
          >
            ...
            <div className="font-mono space-y-2 text-sm md:text-base mb-4">
              ...
              <div className="ml-6 md:ml-10 text-syntax-comment text-xs md:text-sm break-words">
                // {language === 'fr' ? 'Informations de contact et réseaux sociaux' : 'Contact information and social networks'}
              </div>
            </div>
        ...
        >
          <div>{'// ' + (language === 'fr' ? 'N\'hésitez pas à me contacter pour discuter de vos projets !' : 'Feel free to contact me to discuss your projects!')}</div>
          <div>{'// ' + (language === 'fr' ? 'Je serai ravi d\'échanger avec vous 🚀' : 'I will be happy to talk with you 🚀')}</div>
        </motion.div>
      </div>
    </div>
  );
